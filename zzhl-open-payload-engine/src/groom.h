...
/* Closed ZZHL route keeps four distinct sparse reclaim landings. Each
 * candidate is accepted only when its FOPS object and containing page stay
 * inside the leaked order-3 allocation. Returns exactly 4 or zero. */
