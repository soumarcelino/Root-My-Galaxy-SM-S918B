...
kernel_out=${KERNEL_OUT:-$repo_dir/kernelsu-next/out/afzh3-kernel}
...
out_dir="$repo_dir/kernelsu-next/out/kernelsu-next-afzh3-v3.4.0"
patch_file="$repo_dir/kernelsu-next/patches/KernelSU-Next-v3.4.0-samsung-afzh3-kdp-rkp-defex.patch"
