...
#ifndef APP_SLIDE_ROUTE_LABEL
#define APP_SLIDE_ROUTE_LABEL "pselect"
#endif
  pr_success("build config pid=%d label=%s slide=%s main=sigreturn\n",
             getpid(), BUILD_VARIANT_LABEL, APP_SLIDE_ROUTE_LABEL);
