...
git apply /caminho/Root-My-Galaxy-SM-S918B/targets/afzg1/kernelsu-next/patches/KernelSU-Next-v3.3.0-samsung-afzg1-kdp-rkp-defex.patch
```
...
Artefatos são gravados em `targets/afzg1/kernelsu-next/out/kernelsu-next-afzg1/` e permanecem ignorados
pelo Git.
...
```sh
adb push targets/afzg1/kernelsu-next/out/kernelsu-next-afzg1/ksu-helper-next /data/local/tmp/
