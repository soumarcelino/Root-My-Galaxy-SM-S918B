...
out_dir="$repo_dir/targets/afzh3/kernelsu-next/out/kernelsu-next-v3.4.0-release-ko"
module="$repo_dir/targets/afzh3/kernelsu-next/aarch64-android13-5.15_kernelsu.ko"
