# AFZH3 Open Payload Engine — project status
...
`targets/afzh3/reference/kernel/README.md` remains the detailed evidence log. Sections
...
Following the `FUN_00107dd4` re-trace (see `targets/afzh3/reference/kernel/
...
`targets/afzh3/reference/kernel/locking/rtmutex_api.c:436` already has the full
...
(`targets/afzh3/reference/kernel/locking/rtmutex.c:371`) compares
...
`targets/afzh3/reference/kernel/locking/rtmutex.c` (lines 616-999) and
...
`targets/afzh3/reference/kernel/`, so this couldn't be confirmed by source
...
**`targets/afzh3/reference/kernel/futex/core.c`** for permanent, durable local
...
`targets/afzh3/reference/kernel/locking/`).**
...
`targets/afzh3/reference/kernel/locking/rtmutex_api.c:354-372`) that owner's
...
not by inference**: `targets/afzh3/reference/kernel/locking/rbtree.h:33-34`:
```c
...
kernel source (`targets/afzh3/reference/kernel/locking/rtmutex.c`/
`rtmutex_api.c`) and this device's own BTF
(`targets/afzh3/reference/kernel/btf/vmlinux-SAFZH3-5.15.189.btf`, queried via
...
own BTF (`targets/afzh3/reference/kernel/btf/vmlinux-SAFZH3-5.15.189.btf`, via
...
`targets/afzh3/reference/kernel/README.md`'s "Waiter's real post-SIGUSR1 handoff
...
hand-extracted individual files under `targets/afzh3/reference/kernel/`).
