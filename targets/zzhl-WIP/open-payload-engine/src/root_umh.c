...
/* ZZHL addresses from the extracted kernel image and BTF. */
#define SELINUX_ENFORCING_OFF ZZHL_SELINUX_STATE_ENFORCING_OFF
#define SYSTEM_UNBOUND_WQ_OFF ZZHL_SYSTEM_UNBOUND_WQ_OFF
#define CALL_USERMODEHELPER_EXEC_WORK_OFF ZZHL_CALL_USERMODEHELPER_EXEC_WORK_OFF
