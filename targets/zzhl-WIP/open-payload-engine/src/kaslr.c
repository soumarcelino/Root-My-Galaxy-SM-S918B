 ...
 * repository's own open engine at ../../payload/src/slide.c
...
/* ZZHL worker_thread+0x78 call site, derived from its kernel image. */
#define KIMAGE_TEXT_BASE ZZHL_KIMAGE_TEXT_BASE
#define WORKER_CALLER_OFF ZZHL_WORKER_CALLER_OFF
 ...
 * ../../payload/src/slide.c:slide_tracefs_parse_page (already verified against
