...
#define DENTRY_FOPS_NAME_SIZE 0x380
...
/* Builds closed ZZHL's slash/NUL-free dentry name. First 0x118 bytes become
 * the exact file_operations witness after dentry/SKB reclaim. */
